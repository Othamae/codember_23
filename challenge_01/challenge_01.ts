function getMessage(message: string): string {
    ...
    for (let i = 0;i < messageArray.length;i++) {
        const word = messageArray[i].toLowerCase()
        if (hash.get(word)) {
